...
<div class="max-w-4xl mx-auto mt-10 px-4">
    ...
    <div class="mt-6 text-center">
        <a href="{{ route('explore') }}" class="inline-block bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 py-2 rounded shadow hover:brightness-110">← Kembali ke Eksplorasi</a>
    </div>
</div>
