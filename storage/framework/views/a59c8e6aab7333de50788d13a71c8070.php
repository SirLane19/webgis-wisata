...
<?php endif; ?>
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-600 hover:text-gray-900">Register</a>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\ileen\webgis-wisata\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>