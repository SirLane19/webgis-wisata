...
<div class="min-h-screen bg-[#0a192f] text-white flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 relative overflow-hidden">
    ...
    <div class="w-full md:w-1/2 z-10 mt-12 md:mt-0">
        <img src="<?php echo e(asset('images/fun-webgis.png')); ?>" alt="Ilustrasi WebGIS" class="w-full max-w-md mx-auto drop-shadow-xl rounded-xl">
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ileen\webgis-wisata\resources\views/welcome.blade.php ENDPATH**/ ?>